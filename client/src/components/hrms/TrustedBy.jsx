...
import { Factory, Truck, Briefcase, Stethoscope, GraduationCap, LineChart } from 'lucide-react';

const tags = [
  { icon: Factory,        label: 'Manufacturing' },
  { icon: Truck,          label: 'Logistics' },
  { icon: Briefcase,      label: 'Enterprise Services' },
  { icon: Stethoscope,    label: 'Healthcare' },
  { icon: GraduationCap,  label: 'Education' },
  { icon: LineChart,      label: 'Operations Teams' },
];
  ...
  return (
    <section className="relative py-20 md:py-24">
      <div className="max-w-7xl mx-auto px-6 md:px-8 text-center">
        ...
        >
          Built for organizations that need operational clarity and workforce visibility
        </motion.h2>
