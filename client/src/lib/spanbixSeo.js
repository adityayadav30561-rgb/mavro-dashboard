...
export const SPANBIX_CAREER_PATHS = [
  {
    ...
    highlights: [
      'Master GL, AP, AR, asset accounting in S/4HANA',
      'Hands-on sandbox configuration + capstone project',
      'Mentor reviews from active SAP FICO consultants',
    ],
    ...
    whatYoullLearn: [
      'Configure General Ledger, AP, AR, and asset accounting in SAP S/4HANA',
      'Master document splitting, parallel ledgers, and new GL functionality',
      'Build cost centers, profit centers, internal orders, and product costing',
      'Implement integration with the SD and MM modules end-to-end',
      'Run real month-end and year-end close cycles on a live sandbox',
      'Crack the C_TS4FI_2023 certification confidently',
      'Present a capstone implementation that recruiters can verify',
      'Convert mock interviews into real SAP consultant offers',
    ],
    includes: [
...

  {
    ...
    highlights: [
      'End-to-end procure-to-pay workflow mastery',
      'Live S/4HANA sandbox configuration practice',
      'Capstone tuned to real enterprise scenarios',
    ],
    ...
    whatYoullLearn: [
      'Build the procure-to-pay cycle in SAP S/4HANA end-to-end',
      'Configure material master, vendor master, and the purchasing org structure',
      'Master purchase requisitions, RFQs, contracts, and outline agreements',
      'Run inventory management, physical inventory, and stock transfer scenarios',
      'Implement pricing procedures, taxes, and account determination',
      'Handle subcontracting, consignment, and special procurement',
      'Integrate MM with FI, SD, and PP modules end-to-end',
      'Crack the C_TS452_2022 certification confidently',
    ],
    includes: [
...

  {
    ...
    highlights: [
      'Master the order-to-cash lifecycle in S/4HANA',
      'Pricing, billing, and customer master configuration',
      'Mock interviews tuned to SI hiring panels',
    ],
    priceIndividual: '₹44,999',
    priceMrp: '₹60,000',
    ...
    whatYoullLearn: [
      'Master the order-to-cash lifecycle in SAP S/4HANA end-to-end',
      'Configure enterprise structure, sales areas, and document types',
      'Build pricing procedures, condition records, and output determination',
      'Handle quotations, contracts, scheduling agreements, and rebates',
      'Run delivery, picking, packing, and shipping configurations',
      'Implement billing, revenue recognition, and credit management',
      'Integrate SD with MM, FI, and CO modules',
      'Crack the C_TS462_2022 certification confidently',
    ],
    includes: [
      '95+ hours on-demand video',
      '50+ hands-on configuration exercises',
...

  {
    ...
    highlights: [
      'RICEFW objects + S/4HANA extension development',
      'Capstone with reviewed, production-grade code',
    ...
    whatYoullLearn: [
      'Master the ABAP workbench, Data Dictionary, and internal tables',
      'Build classical, interactive, and ALV reports',
      'Develop module pool (dialog) programs with screen logic',
      'Master BDC, LSMW, and modern data migration approaches',
      'Build SAPScript, SmartForms, and Adobe Form layouts',
      'Implement Object-Oriented ABAP and ABAP Objects',
      'Master BADIs, user exits, and customer enhancements',
      'Ship a production-grade RICEFW capstone for portfolio',
    ],
    includes: [
...
export const SPANBIX_CAMPUS_PROGRAM = {
  ...
  highlights: [
    'Bulk CSV student onboarding (200–2,000 learners per cohort)',
    'AICTE / NAAC-aligned curriculum + NSDC funding pathways',
    'Attendance-linked content unlock + T&P readiness dashboards',
    'College-branded co-certification + hiring partner alignment',
  ],
};
