...
export const SPANBIX_CAREER_PATHS = [
...

  {
    ...
    category: 'ai',
    audience: 'For students, professionals, founders & creators',
    salaryRange: '₹4L – ₹18L+',
    duration: '8 weeks',
    eligibility: 'No prerequisite',
    demand: 'Explosive',
    beginner: true,
    summary:
      'Master how to actually use AI — prompt engineering, AI image and video generation, content and research workflows, and building real apps and automations with AI. This is not an AI-development course; it is a course on extracting the maximum from AI tools in your work and creative life.',
    highlights: [
      'Prompt engineering for any AI model',
      'Create images, video & content with AI',
      'Build real apps & automations with AI',
      'Personality development module',
    ],
    ...
    instructor: {
      name: 'Kabir Anand',
      title: 'AI Product Builder & Prompt Engineering Lead',
      bio: 'Kabir has shipped AI-powered products and automation systems for startups and agencies, and trains teams on getting real output from LLMs, image, and video models. He focuses on practical, tool-agnostic workflows over theory.',
    },
    whatYoullLearn: [
      'Write prompts that get reliable, high-quality output from any AI model',
      'Generate professional images and design assets with AI',
      'Produce video, voice, and audio content using AI tools end-to-end',
      'Automate content, research, and busywork with AI workflows',
      'Build and ship real apps using AI-assisted (no/low-code) tools',
      'Present your AI work confidently via the personality development module',
    ],
    includes: [
      'Live mentor sessions + recorded library',
      'Hands-on projects across text, image, video & apps',
      'A reusable prompt + workflow library',
      'Mentor-reviewed capstone project',
      'Portfolio + interview support',
      'Personality development module',
    ],
    requirements: [
      'Open to anyone — students, professionals, founders, creators',
    ...
    individualTimeline: [
      {
        id: 'm1',
        title: 'Module 01 · AI Foundations & How Models Think',
        meta: 'Week 1 · 10 lessons · 6h',
        topics: [
          'The current AI landscape — text, image, video, audio, agents',
          'How large language models actually work (no maths)',
          'Strengths, limits, and where AI goes wrong (hallucination)',
      ...
      },
      {
        ...
        meta: 'Weeks 2–3 · 16 lessons · 12h',
        topics: [
          'Anatomy of a great prompt — role, context, constraints, examples',
          'Chain-of-thought, few-shot, and structured-output prompting',
          'System prompts, custom GPTs, and reusable prompt templates',
          'Iterating, debugging, and getting consistent results',
        ],
      },
      {
        id: 'm3',
        title: 'Module 03 · AI for Images & Design',
        meta: 'Week 4 · 12 lessons · 9h',
        topics: [
          'Generating images with Midjourney, DALL·E & open models',
          'Prompting for style, composition, and brand consistency',
          'Editing, upscaling, and product/marketing visuals',
          'Practical design workflows for social, ads, and decks',
        ],
      },
      {
        id: 'm4',
        title: 'Module 04 · AI for Video, Voice & Audio',
        meta: 'Week 5 · 12 lessons · 9h',
        topics: [
          'AI video generation and editing tools end-to-end',
          'Avatars, faceless videos, and short-form content at scale',
          'AI voiceover, dubbing, and music generation',
          'A repeatable content-production pipeline',
        ],
      },
      {
        id: 'm5',
        title: 'Module 05 · AI for Content, Research & Productivity',
        meta: 'Week 6 · 14 lessons · 10h',
        topics: [
          'Writing, editing, and repurposing content with AI',
          'Research, summarisation, and working with your own documents',
          'Spreadsheets, email, and everyday work automation',
          'Connecting tools with AI to remove busywork',
        ],
      },
      {
        id: 'm6',
        title: 'Module 06 · Building Apps & Automations with AI',
        meta: 'Week 7 · 14 lessons · 12h',
        topics: [
          'Building real apps with AI-assisted (no/low-code) tools',
          'Designing and shipping a working product from an idea',
          'Automations and AI agents that run on autopilot',
          'Connecting APIs and AI without heavy programming',
        ],
      },
      {
        id: 'm7',
        title: 'Module 07 · Capstone + Portfolio',
        meta: 'Week 8 · Project + Showcase',
        topics: [
          'Ship a real AI project — app, content system, or workflow',
          'Build a portfolio that proves your AI skills',
          'Mentor review + presentation polish',
          'Personality development module + showcase day',
        ],
      },
    ],
    campusTimeline: [
