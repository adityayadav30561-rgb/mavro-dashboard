...
const DISMISS_KEY = 'spanbix-cohort-banner-dismissed-1';
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Batch starts <span style={{ fontStyle: 'italic' }}>8 June 2026.</span>
        </h2>
        ...
        >
          <Row icon="📅" label="STARTS" value="Monday · 8 June 2026" />
